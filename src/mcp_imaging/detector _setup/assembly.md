...
| MCP Circular Spring Wedge | Class 100 Workbench, Petri Dishes |
| MCP Clamp Circular Leaf Spring | Class 100 Workbench, Petri Dishes |
| Spacing rings (varying thicknesses) | Class 100 Workbench, Petri Dishes |



#### Step 2: Cleaning the Detector
{: .fw-700 }
1. Clear the detector with pulses of N2 from the Nitrogen gun.
    <br />
    <p align:center style="width:60%; margin: auto;">
...
3. Align the notch to point towards the label "BOT" on the detector (usually on the sides of the conflat).
    <br />
    <p align:center style="width:60%; margin: auto;">
...
4. Use the **tweezers** to hold the mid-voltage contact ring in place and out of the way, and put the bottom MCP inside the detector. Ensure that the bias angle is aligned with the "BOT" label on the detector. 
...
3. Place spacers on top of the plate in the following order:
    - **MCP Circular Spring Wedge** (with the cross-section of smaller radius at the top)
    - **MCP Clamp Leaf Spring** 
    - **MCP cover** (to protect the plates in the current step; to be removed later)
    - Stack of spacer rings
  ...
  {: .note }
  > Depending on the MCPs under test, you will need to have a different stackup of spacer rings. When choosing space rings, ensure that the final stackup of rings protrudes by 1mm or slightly less. This will be enough clamping force to hold the MCPs in place, **DO NOT OVERCOMPRESS THE MCPs**. They are fragile and can crack.

#### Step 5: Attaching Detector Window
{: .fw-700 }
